...
@push('styles')
<style>
        /* --- 1. Thiết lập chung & Bảng màu (Giữ nguyên) --- */
        :root {
...
<section class="hero-section container">
        <div class="hero-content">
            ...
            <div class="hero-buttons">
                <a href="#" class="btn btn-primary">Đăng ký tư vấn</a>
                <a href="#pricing" class="btn btn-secondary">Xem gói dịch vụ</a>
            </div>
        </div>
    ...
    <section id="pricing" class="pricing container">
        ...
        <p class="pricing-intro">Các gói dịch vụ được thiết kế linh hoạt theo nhu cầu thực tế của gia đình. Vui lòng liên hệ để nhận báo giá chi tiết và chính xác nhất.</p>
